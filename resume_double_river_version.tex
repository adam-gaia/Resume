...
\begin{itemize}
    \item \textbf{Bitcoin Trading Bot:}
        \textit{Ongoing python project with a friend}
        \begin{itemize}
            ...
            \item Deployed the bot with Docker-Compose on a RaspberryPi computer
        \end{itemize}
    \vspace{4mm}
...
\begin{itemize}
    ...
    \item \textbf{Tools:} Git, CI/CD, Docker, ssh, MPI, Unix/Linux, Arduino microcontrollers, \LaTeX
